...
//   // define GCV calibrator
//   std::size_t seed = 476813;
//   enum StochasticEDFMethod method;
//   method = fdaPDE::calibration::StochasticEDFMethod::Cholesky;  
//   GCV<decltype(model), StochasticEDF<decltype(model)>> GCV(model, 1000, seed);
//   GridOptimizer<1> opt;
...
//   // Lambda vector
//   std::ofstream fileGCV_lambda("data/models/SQRPDE/2D_test1_GCV/Stochastic/GCV_lambdasCpp_" + alpha_string + ".csv");
//   for(std::size_t i = 0; i < lambdas.size(); ++i) 
//     fileGCV_lambda << std::setprecision(16) << lambdas[i] << "\n" ; 
...
//   // GCV scores
//   std::ofstream fileGCV_scores("data/models/SQRPDE/2D_test1_GCV/Stochastic/GCV_scoresCpp_" + alpha_string + ".csv");
//   for(std::size_t i = 0; i < GCV.values().size(); ++i) 
//     fileGCV_scores << std::setprecision(16) << std::sqrt(GCV.values()[i]) << "\n" ; 
...
//   // Edf
//   std::ofstream fileGCV_edf("data/models/SQRPDE/2D_test1_GCV/Stochastic/GCV_edfCpp_" + alpha_string + ".csv");
//   for(std::size_t i = 0; i < GCV.edfs().size(); ++i) 
//     fileGCV_edf << std::setprecision(16) << GCV.edfs()[i] << "\n" ; 
...
/* test 11
   ...
   GCV optimization: grid exact
 */
// TEST(GCV_SQRPDE, Test10_Laplacian_SemiParametric_GeostatisticalAtLocations_GridExact) {
//   // define domain and regularizing PDE
//   MeshLoader<Mesh2D<>> domain("c_shaped");
//   auto L = Laplacian();
//   DMatrix<double> u = DMatrix<double>::Zero(domain.mesh.elements()*3, 1);
...
//   // Lambda vector
//   std::ofstream fileGCV_lambda("data/models/SQRPDE/2D_test2_GCV/Eaxct/GCV_lambdasCpp_" + alpha_string + ".csv");
//   for(std::size_t i = 0; i < lambdas.size(); ++i) 
//     fileGCV_lambda << std::setprecision(16) << lambdas[i] << "\n" ; 
...
//   // GCV scores
//   std::ofstream fileGCV_scores("data/models/SQRPDE/2D_test2_GCV/Exact/GCV_scoresCpp_" + alpha_string + ".csv");
//   for(std::size_t i = 0; i < GCV.values().size(); ++i) 
//     fileGCV_scores << std::setprecision(16) << std::sqrt(GCV.values()[i]) << "\n" ; 
...
//   // Edf
//   std::ofstream fileGCV_edf("data/models/SQRPDE/2D_test2_GCV/Exact/GCV_edfCpp_" + alpha_string + ".csv");
//   for(std::size_t i = 0; i < GCV.edfs().size(); ++i) 
//     fileGCV_edf << std::setprecision(16) << GCV.edfs()[i] << "\n" ; 
...
//   // Lambda vector
//   std::ofstream fileGCV_lambda("data/models/SQRPDE/2D_test2_GCV/Stochastic_Woodbury/GCV_lambdasCpp_" + alpha_string + ".csv");
//   for(std::size_t i = 0; i < lambdas.size(); ++i) 
//     fileGCV_lambda << std::setprecision(16) << lambdas[i] << "\n" ; 
...
//   // GCV scores
//   std::ofstream fileGCV_scores("data/models/SQRPDE/2D_test2_GCV/Stochastic_Woodbury/GCV_scoresCpp_" + alpha_string + ".csv");
//   for(std::size_t i = 0; i < GCV.values().size(); ++i) 
//     fileGCV_scores << std::setprecision(16) << std::sqrt(GCV.values()[i]) << "\n" ; 
...
//   // Edf
//   std::ofstream fileGCV_edf("data/models/SQRPDE/2D_test2_GCV/Stochastic_Woodbury/GCV_edfCpp_" + alpha_string + ".csv");
//   for(std::size_t i = 0; i < GCV.edfs().size(); ++i) 
//     fileGCV_edf << std::setprecision(16) << GCV.edfs()[i] << "\n" ; 
...
/* test 13
   ...
   GCV optimization: grid exact
 */
// TEST(GCV_SQRPDE, Test13_Laplacian_SemiParametric_GeostatisticalAtLocations_GridExact) {
//   // define domain and regularizing PDE
//   MeshLoader<Mesh2D<>> domain("c_shaped");
//   auto L = Laplacian();
//   DMatrix<double> u = DMatrix<double>::Zero(domain.mesh.elements()*3, 1);
...
//   // load locations where data are sampled
//   CSVFile<double> locFile;
//   locFile = reader.parseFile("data/models/SQRPDE/2D_test13_GCV/locs.csv");
//   DMatrix<double> loc = locFile.toEigen();
...
//   // load data from .csv files
//   CSVFile<double> yFile; // observation file
//   yFile = reader.parseFile  ("data/models/SQRPDE/2D_test13_GCV/z.csv");
//   DMatrix<double> y = yFile.toEigen();
//   CSVFile<double> XFile; // design matrix
//   XFile = reader.parseFile  ("data/models/SQRPDE/2D_test13_GCV/X.csv");
//   DMatrix<double> X = XFile.toEigen();
...
//   // define grid of lambda values
//   std::vector<SVector<1>> lambdas;
//   for(double x = 1.0; x <= 5.0; x +=0.25) lambdas.push_back(SVector<1>(std::pow(10,x)));
//   // lambdas.push_back(SVector<1>(0.01778279410038923));
...
//   // Lambda vector
//   std::ofstream fileGCV_lambda("data/models/SQRPDE/2D_test13_GCV/Exact/GCV_lambdasCpp_" + alpha_string + ".csv");
//   for(std::size_t i = 0; i < lambdas.size(); ++i) 
//     fileGCV_lambda << std::setprecision(16) << lambdas[i] << "\n" ; 
...
//   // GCV scores
//   std::ofstream fileGCV_scores("data/models/SQRPDE/2D_test13_GCV/Exact/GCV_scoresCpp_" + alpha_string + ".csv");
//   for(std::size_t i = 0; i < GCV.values().size(); ++i) 
//     fileGCV_scores << std::setprecision(16) << std::sqrt(GCV.values()[i]) << "\n" ; 
...
//   // Edf
//   std::ofstream fileGCV_edf("data/models/SQRPDE/2D_test13_GCV/Exact/GCV_edfCpp_" + alpha_string + ".csv");
//   for(std::size_t i = 0; i < GCV.edfs().size(); ++i) 
//     fileGCV_edf << std::setprecision(16) << GCV.edfs()[i] << "\n" ; 
...
//   // load data from .csv files
//   CSVFile<double> yFile; // observation file
//   yFile = reader.parseFile  ("data/models/SQRPDE/2D_test12_GCV/z.csv");
//   DMatrix<double> y = yFile.toEigen();
//   CSVFile<double> XFile; // design matrix
//   XFile = reader.parseFile  ("data/models/SQRPDE/2D_test12_GCV/X.csv");
//   DMatrix<double> X = XFile.toEigen();
...
//     GCV(model, 100, seed, StochasticEDFMethod::Woodbury); 
//   GridOptimizer<1> opt;

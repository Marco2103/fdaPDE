...
//   Eigen::loadMarket(expectedPsi, "data/models/SQRPDE/2D_test2/Psi.mtx");
...
//   Eigen::loadMarket(expectedR0,  "data/models/SQRPDE/2D_test2/R0.mtx");
...
//   Eigen::loadMarket(expectedR1,  "data/models/SQRPDE/2D_test2/R1.mtx");

...
TEST(SQRPDE, Test2_Laplacian_SemiParametric_GeostatisticalAtLocations) {
  ...
  std::vector<int> seq_n = {4614, 3671, 2247, 1619, 1264, 1046, 903, 696, 627, 597, 241, 171} ; 
  std::vector<std::string> seq_n_string = {"4614", "3671", "2247", "1619", "1264", "1046", "903", "696", "627", "597", "241", "171"} ; 

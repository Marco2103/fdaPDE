...
RcppExport SEXP _rcpp_module_boot_FPCA_Laplacian_2D_GeoStatLocations();
RcppExport SEXP _rcpp_module_boot_FPCA_Laplacian_3D_GeoStatNodes();
RcppExport SEXP _rcpp_module_boot_GapFill_Laplacian_2D_GeoStatNodes();
RcppExport SEXP _rcpp_module_boot_GapFill_Laplacian_2D_GeoStatLocations();
RcppExport SEXP _rcpp_module_boot_STRPDE_Laplacian_2D_GeoStatNodes();
RcppExport SEXP _rcpp_module_boot_STRPDE_Laplacian_2D_GeoStatLocations();
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rcpp_module_boot_FPCA_Laplacian_2D_GeoStatLocations", (DL_FUNC) &_rcpp_module_boot_FPCA_Laplacian_2D_GeoStatLocations, 0},
    {"_rcpp_module_boot_FPCA_Laplacian_3D_GeoStatNodes", (DL_FUNC) &_rcpp_module_boot_FPCA_Laplacian_3D_GeoStatNodes, 0},
    {"_rcpp_module_boot_GapFill_Laplacian_2D_GeoStatNodes", (DL_FUNC) &_rcpp_module_boot_GapFill_Laplacian_2D_GeoStatNodes, 0},
    {"_rcpp_module_boot_GapFill_Laplacian_2D_GeoStatLocations", (DL_FUNC) &_rcpp_module_boot_GapFill_Laplacian_2D_GeoStatLocations, 0},
    {"_rcpp_module_boot_STRPDE_Laplacian_2D_GeoStatNodes", (DL_FUNC) &_rcpp_module_boot_STRPDE_Laplacian_2D_GeoStatNodes, 0},
    {"_rcpp_module_boot_STRPDE_Laplacian_2D_GeoStatLocations", (DL_FUNC) &_rcpp_module_boot_STRPDE_Laplacian_2D_GeoStatLocations, 0},

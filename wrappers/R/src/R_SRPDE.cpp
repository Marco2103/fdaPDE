...
// using fdaPDE::models::SamplingDesign; // M added
...
// SRPDE_MODULE(Laplacian_2D_Order1, SamplingDesign::GeoStatMeshNodes); 
// // definition of Rcpp module
// typedef R_SRPDE<Laplacian_2D_Order1, SamplingDesign::GeoStatMeshNodes>
...
// SRPDE_MODULE(Laplacian_2D_Order1, SamplingDesign::GeoStatLocations);//,
// //	     void set_locations(const DMatrix<double>& data) { model_.setLocations(data); }
// // )
// // definition of Rcpp module
// typedef R_SRPDE<Laplacian_2D_Order1, SamplingDesign::GeoStatLocations>
...
// SRPDE_MODULE(Laplacian_2D_Order1, SamplingDesign::Areal,
// 	     void set_subdomains(const DMatrix<int>& data) { model_.setSubdomains(data); }
// 	     )
// // definition of Rcpp module
// typedef R_SRPDE<Laplacian_2D_Order1, SamplingDesign::Areal>
...
// SRPDE_MODULE(ConstantCoefficients_2D_Order1, SamplingDesign::GeoStatMeshNodes); 
// // definition of Rcpp module
// typedef R_SRPDE<ConstantCoefficients_2D_Order1, SamplingDesign::GeoStatMeshNodes>
...
// SRPDE_MODULE(ConstantCoefficients_2D_Order1, SamplingDesign::GeoStatLocations);//,
// //void set_locations(const DMatrix<double>& data) { model_.setLocations(data); }
// //	     )
// // definition of Rcpp module
// typedef R_SRPDE<ConstantCoefficients_2D_Order1, SamplingDesign::GeoStatLocations>
...
// SRPDE_MODULE(ConstantCoefficients_2D_Order1, SamplingDesign::Areal,
// 	     void set_subdomains(const DMatrix<int>& data) { model_.setSubdomains(data); }
// 	     )
// // definition of Rcpp module
// typedef R_SRPDE<ConstantCoefficients_2D_Order1, SamplingDesign::Areal>
...
// SRPDE_MODULE(SpaceVarying_2D_Order1, SamplingDesign::GeoStatMeshNodes); 
// // definition of Rcpp module
// typedef R_SRPDE<SpaceVarying_2D_Order1, SamplingDesign::GeoStatMeshNodes>
...
// SRPDE_MODULE(SpaceVarying_2D_Order1, SamplingDesign::GeoStatLocations);//,
// 	     //void set_locations(const DMatrix<double>& data) { model_.setLocations(data); }
// 	     //)
// // definition of Rcpp module
// typedef R_SRPDE<SpaceVarying_2D_Order1, SamplingDesign::GeoStatLocations>
...
// SRPDE_MODULE(SpaceVarying_2D_Order1, SamplingDesign::Areal,
// 	     void set_subdomains(const DMatrix<int>& data) { model_.setSubdomains(data); }
// 	     )
// // definition of Rcpp module
// typedef R_SRPDE<SpaceVarying_2D_Order1, SamplingDesign::Areal>

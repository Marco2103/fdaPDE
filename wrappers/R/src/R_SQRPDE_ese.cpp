...
public:
  ...
  void setMassLumpingSystem(const bool &lump){ regularization_.pde().setMassLumpingSystem(lump); }
...
// 2D, areal, laplacian 
typedef R_SQRPDE<Laplacian_2D_Order1, fdaPDE::models::GeoStatLocations> SQRPDE_Laplacian_2D_Areal;
...
// // 1.5D, locations == nodes, laplacian 
...
//     .method("locs",       &SQRPDE_Laplacian_1_5D_GeoStatNodes::locs)
//     // setters
...
//     .method("set_locations",  &SQRPDE_Laplacian_1_5D_GeoStatNodes::set_locations)
